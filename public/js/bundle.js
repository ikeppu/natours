      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return (0, _axios.default)('http://localhost:3000/api/v1/users/signup', {
              method: 'POST',
              withCredentials: true,
              credentials: 'include',
              data: {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              // document.cookie = `jwt=${res.data.token}; secure;samesite =none;`;
              (0, _alert.showAlert)('success', 'Register in successfully');
              window.setTimeout(function () {
                location.assign('/');
              }, 1000);
            }
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'update-password' : 'update-self';
            _context.next = 4;
            return (0, _axios.default)("http://localhost:3000/api/v1/users/".concat(url), {
              method: 'PUT',
              withCredentials: true,
              credentials: 'include',
              data: data
...
var stripe = Stripe('pk_test_51JgE9GDQTIcfXAX8coQ4jTeZTLwTL3Uit3ppeuWfcNNccxFdltFy8CZXVgCy7JfXnjjBKcYvS2XcXjRglkwoOAnv00DSOkgiVV');
...
if (registerForm) {
  registerForm.addEventListener('submit', function (e) {
    ...
    var name = document.getElementById('username-reg').value;
    var password = document.getElementById('password-reg').value;
    var passwordConfirm = document.getElementById('passwordConfirm-reg').value;
    (0, _auth.register)(email, name, password, passwordConfirm);
  });
}
